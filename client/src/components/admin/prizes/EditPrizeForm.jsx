...
import { updatePrize } from '../../../app/prize/prizeSlice.js';
import { useDispatch } from 'react-redux';




export default function AddPrizeForm({ prizeToEdit, setSelectedPrizeToEdit }) {
    const [prize, setPrize] = useState({ ...prizeToEdit });
    ...
    const submitFormFunc = async (e) => {
        ...
        const r = await dispatch(updatePrize(prizeData));
            ...
            {wait ? (
                ...
                <form className="needs-validation p-2">
                    ...
                    <button
                        ...
                        type="button"
                        id="btnProductSubmit"
                        onClick={() => { setSelectedPrizeToEdit({}) }}
                    >
                        cancel
                </button>
                </form>
